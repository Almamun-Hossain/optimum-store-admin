        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Management */}
              <SidebarLinkGroup
                activecondition={pathname.includes("customers") || pathname.includes("inventory") || pathname.includes("shipping") || pathname.includes("notification") || pathname.includes("users")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
